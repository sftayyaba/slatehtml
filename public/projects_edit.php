...
?>
		<div id="editProjects" class="container-fluid">
			<?php
				...
				<form>
					<div class="row">
						...
						<div class="col">
							<p>Project details</p>
							<div class="form-group">
								<label class="fs-xs text-muted">Portfolio *</label>
							...
							<div class="form-group">
								<label class="fs-xs text-muted">Template <i class="fas fa-exclamation-circle"></i></label>
								<select class="form-select">
									<option></option>
							...
							<div class="form-group">
								<label class="fs-xs text-muted">Type</label>
								<select class="form-select">
									<option></option>
							...
							<div class="form-group">
								<label class="fs-xs text-muted">Stage</label>
								<select class="form-select">
									<option></option>
							...
							<div class="form-group">
								<label class="fs-xs text-muted">Temperature</label>
								<select class="form-select">
									<option></option>
									<option>100</option>
								</select>
							...
							<div class="form-group">
								<label class="fs-xs text-muted">Measurement</label>
								<select class="form-select">
									<option></option>
									<option>100</option>
								</select>
							...
							<div class="form-group">
								<label class="fs-xs text-muted">Currency</label>
								<select class="form-select">
									<option></option>
									<option>USD</option>
								</select>
						...
						<div class="col">
							<p>Add teammates</p>
							<div class="form-group">
								<label class="fs-xs text-muted">Select a Teammate</label>
								<select class="form-select">
									<option></option>
									<option>Portfolio 1</option>
								</select>
							...
							<div class="mt-auto">
 								<div class="row">
									<div class="col text-center">
										<button type="button" class="btn btn-bordered w-100" >Cancel</button>
									</div>
									<div class="col text-center">
										<button type="button" id="btnCreateTeammate" class="btn btn-primary w-100">Save</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script>
		...
		btnAddProject.addEventListener('click', function (event) {
			if (addProject.classList.contains('show')) {
				...
				addBackdrop(addProject, 'projects');
			}
		});
