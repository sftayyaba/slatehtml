...
var lightGradientEL = document.querySelector("#lightGradient");
lightGradientEL &&
  lightGradientEL.addEventListener("change", (event) => {
...
var lightHeaderEL = document.querySelector("#lightHeader");
lightHeaderEL &&
  lightHeaderEL.addEventListener("change", (event) => {
    var checked = event.target.checked;
    if (checked) {
...
var whiteHeaderEL = document.querySelector("#whiteHeader");
whiteHeaderEL &&
  whiteHeaderEL.addEventListener("change", (event) => {
    var checked = event.target.checked;
    if (checked) {
